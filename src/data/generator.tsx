...
const DAT_AKK_DATA: { segs: ("a" | string)[]; a: string; sol: string; en: string; tip: string; why: ReactNode }[] = [
  {
    segs: ["Ich ", "a", " dir gern."],
    a: "helfe", sol: "Ich helfe dir gern.",
    en: "I like helping you.",
    tip: "helfen ist ein Dativ-Verb — ich helfe, du hilfst.",
    why: <><B>helfen</B> für „ich" = <B>helfe</B>. Vokalwechsel nur in der 2./3. Person Singular.</>,
  },
  {
    segs: ["Kannst du ", "a", " bitte?"],
    a: "mir", sol: "Kannst du mir bitte?",
    en: "Can you please help me?",
    tip: "helfen = Dativ — Wem helfst du? mir.",
    why: <><B>helfen</B> regiert den Dativ: <B>mir</B>, nicht „mich“.</>,
  },
  {
    segs: ["Du ", "a", " viel lernen."],
    a: "musst", sol: "Du musst viel lernen.",
    en: "You have to learn a lot.",
    tip: "müssen — du musst. Vokalwechsel ü→u!",
    why: <><B>müssen</B> für „du" = <B>musst</B>. Vokalwechsel: ü → u.</>,
  },
  {
    segs: ["Er ", "a", " pünktlich sein."],
    a: "darf", sol: "Er darf pünktlich sein.",
    en: "He may be punctual.",
    tip: "dürfen — er darf. Kein -st in der 3. Person!",
    why: <><B>dürfen</B> für „er" = <B>darf</B>. Vokalwechsel: ü → a, kein -st.</>,
  },
  {
    segs: ["Wir ", "a", " Deutsch."],
    a: "lernen", sol: "Wir wollen Deutsch lernen.",
    en: "We want to learn German.",
    tip: "wollen — wir wollen. Infinitiv am Satzende.",
    why: <><B>wollen</B> für „wir" = <B>wollen</B>. Infinitiv steht am Satzende.</>,
  },
  {
    segs: ["Sie ", "a", " dem Kind helfen."],
    a: "soll", sol: "Sie soll dem Kind helfen.",
    en: "She should help the child.",
    tip: `sollen — sie soll. Dativ \u201Edem Kind\u201C nach helfen.`,
    why: <><B>sollen</B> für „sie" = <B>soll</B>. Dativ-Objekt bleibt im Dativ.</>,
  },
];
